...
export default function LandingPage() {
  return (
    <main className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300 min-h-screen">
        {/* Hero Section */}
    <section className="flex flex-col-reverse lg:flex-row justify-center py-28 px-40 items-start">
  {/* Text Content */}
  <motion.div
     initial={{ opacity: 0, y: 40 }}
     whileInView={{ opacity: 1, y: 0 }}
     transition={{ duration: 0.8 }}
     viewport={{ once: false }} className="w-full lg:w-1/2 pr-8 space-y-12">
    ...
    <Link
      href="/dashboard"
      className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-15 py-5 rounded-md transition duration-200 cursor-pointer block w-fit"
    >
      Get Started
    </Link>

    <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300">Master topics with notes, quizzes, and flashcards.</p>
  </motion.div>
  ...
  <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: false }} className="w-full lg:w-1/2 flex justify-center">
    <div className="w-full rounded-xl overflow-hidden shadow-[0_0_30px_rgba(59,130,246,0.6)] border-2 border-blue-400">
      <video
        src="/demo.mp4"
        autoPlay
        muted
  ...
  viewport={{ once: false, amount: 0.4 }}
    ...
    viewport={{ once: false }} className="flex items-center gap-4 mb-4">
            <img
              src={t.logo}
    ...
    <section className="py-20 px-6 bg-white dark:bg-gray-900 text-center">
      <div className="max-w-5xl mx-auto">
        <motion.h2
            ...
            viewport={{ once: false }} className="text-3xl font-bold mb-10">Why Choose LearnQuick AI?</motion.h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-8">
          {[
            ...
            },
            {
              ...
              description: "Make learning fun with competitive, timed quizzes and leaderboards that keep you engage",
            ...
            <motion.div
                ...
                viewport={{ once: false }} className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
    ...
    {/* Footer */}
    <footer className="text-center text-sm text-gray-600 dark:text-gray-400 py-6 px-4 border-t border-gray-20dark:border-gray-700">
      <p>
