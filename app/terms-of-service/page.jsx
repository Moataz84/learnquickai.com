      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              If you have any questions about these Terms, please contact us at <a className="text-blue-500 hover:underline" href="mailto:support@learnquickai.com">support@learnquickai.com</a>.
            </p>
          </section>
        </div>
      </div>
