  ...
  return (
    <div className="flex flex-col w-full h-screen items-center justify-center">
      <div className="w-sm mx-auto p-6 space-y-4 bg-white dark:bg-gray-800 rounded-lg shadow-md text-gray-600 dark:text-gray-300 mb-10 relative overflow-hidden">
        ...
        <Link href="/auth/forgot-password" className="underline w-full block text-right text-sm dark:text-gray-400">
          Forgot Password
        </Link>
        ...
        <Button className="w-full cursor-pointer" onClick={loginClient}>
          Login
        </Button>
